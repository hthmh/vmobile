<template>
  <div>
    ...
    <scroller lock-x scrollbar-y use-pullup height="200px" @on-pullup-loading="load1" ref="demo1" :pullup-config="{loadingContent:'加载中...'}">
      <div class="box2">
    ...
    <p @click="demo3Value.pullupStatus='enabled'" v-show="n3 === 30">点击重新启用pullup</p>
