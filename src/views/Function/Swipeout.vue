  ...
  <div>
    <div class="vux-1px-t">
      ...
      <swipeout>
        ...
        <swipeout-item :disabled="disabled" ref="swipeoutItem" :right-menu-width="180" :sensitivity="15">
          <div slot="right-menu">
            ...
            <swipeout-button @click.native="onButtonClick('ignore')" type="default" :width="40">Ignore</swipeout-button>
          </div>
