  ...
  <div>
    ...
    <group title="disabled">
      ...
      <cell title="Opacity" :inline-desc="'valus is: '+data8" primary="content">
        <range v-model="data8" disabled :disabled-opacity="0.05"></range>
      </cell>
    </group>
    ...
    <group title="custom min and max html">
      <cell title="文字大小12" :inline-desc="'font size: ' + data10" primary="content">
        <range v-model="data10" :min="12" :max="22" minHTML="<span style='font-size:12px;color:red;'>12%</span>" maxHTML="<span style='font-size:12px;color:red;'>22%</span>"></range>
      </cell>
...
<script>
import { Range, GroupTitle } from 'vux'
